...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return KZAuthHeroScaffold(
      heroSubtitle: 'auth.signup_subtitle'.tr(),
      showBackButton: true,
      onBack: () {
          ...
          Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Terms checkbox
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: KZ.sp4),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      SizedBox(
                        ...
                        child: Checkbox(
                          ...
                          side: const BorderSide(color: KZ.outline, width: 1.5),
                          onChanged: (val) {
                            setState(() {
                      ...
                      Expanded(
                        child: RichText(
                          text: TextSpan(
                            style: KZ.bodySmall.copyWith(height: 1.4),
                            children: [
