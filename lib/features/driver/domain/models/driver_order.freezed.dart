...
mixin _$DriverOrder {
 ...
 String get id; String get orderNumber; OrderStatus get status; List<OrderItem> get items; OrderDeliveryAddress? get deliveryAddress; FulfillmentType get deliveryMethod; String get customerName; String? get customerPhone; String get paymentMethod; String get paymentStatus; double get amountToCollect; double get totalAmount; DateTime get createdAt; int get assignmentVersion; double? get deliveryDistanceKm; int? get deliveryDurationSeconds;
...
switch (_that) {
case _DriverOrder() when $default != null:
return $default(_that.id,_that.orderNumber,_that.status,_that.items,_that.deliveryAddress,_that.deliveryMethod,_that.customerName,_that.customerPhone,_that.paymentMethod,_that.paymentStatus,_that.amountToCollect,_that.totalAmount,_that.createdAt,_that.assignmentVersion,_that.deliveryDistanceKm,_that.deliveryDurationSeconds);case _:
  return orElse();
