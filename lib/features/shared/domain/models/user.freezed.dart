      ...
      _value.copyWith(
            ...
            addressIds: null == addressIds
                ...
                : addressIds // ignore: cast_nullable_to_non_nullable
                      as List<String>,
            favoriteItemIds: null == favoriteItemIds
                ? _value.favoriteItemIds
                : favoriteItemIds // ignore: cast_nullable_to_non_nullable
                      as List<String>,
            loyaltyAccountId: freezed == loyaltyAccountId
                ? _value.loyaltyAccountId
                : loyaltyAccountId // ignore: cast_nullable_to_non_nullable
                      as String?,
            role: freezed == role
                ? _value.role
...
class _$UserImpl implements _User {
  const _$UserImpl({
    ...
    required this.name,
    this.email,
    final List<String> addressIds = const [],
